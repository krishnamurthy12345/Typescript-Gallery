    ...
    return (
        <>
            <button type="button"
                ...
                className={twMerge("rounded-lg border border-dashed border-grey-300 flex flex-col items-center justify-center cursor-pointer hover:bg-gray-100 transition-colors duration-500 aspect-square p-8")}>
                <ImageIcon />
            ...
            <form onSubmit={handleImageSubmit} className="realtive py-12 px-6 bg-neutral-50 w-[680px] max-h-[95vh]">
